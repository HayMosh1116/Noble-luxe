...
const products = [
  ...
  { id: "nl-002", name: "Noble Heavyweight Hoodie", category: "Hoodies", price: 20000, imageUrl: "https://i.ibb.co/1G651fpS/Gqe-R9-DX2qs.jpg", description: "Dense cotton fleece, relaxed fit, signature chest embroidery.", sizes: ["S", "M", "L", "XL", "XXL"], colors: ["Onyx", "Bone"], featured: true },
