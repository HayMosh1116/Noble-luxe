    ...
    >
      ...
      {selectedImages.back && (
        <p className="mt-2 font-mono-brand text-[8px] uppercase tracking-[0.12em] text-muted-foreground">
          {showBack ? 'Back view · Tap to return' : 'Front view · Tap to see back'}
        </p>
      )}
    </article>
  );
...
export default function Storefront({
  ...
  /*
   * If your API has products, they remain the main catalogue.
   * If the API returns nothing, our local catalogue appears.
   */
  const products =
